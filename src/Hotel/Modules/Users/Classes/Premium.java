...
public class Premium extends User {
	...
	// CONSTRUCTOR
	public Premium(String username, String password, String gmail, Fecha f_alta_web, String nacionalidad,
			Fecha f_nacimiento, String Genero, int Num_reservas) {
	...
	public String toString() {
		...
		String cad = "";
		String[] opc_menu_read = { "ALL DATES", "Username", "Password", "Gmail", "Website registration date",
				"Nationality", "Date of birth", "Gender", "Number of reservations", "Go Back" };

		do {
			menuOptions = function_menu.combo_String(opc_menu_read, "What do you want to read:", "READ USER PREMIUM");
			switch (menuOptions) {
			case "ALL DATES":
				...
				cad = cad + (" Number of reservations: " + this.getNum_reservas() + " \n");
			case "Username":
				cad = cad + ("Username: " + super.getUsername() + "\n");
				break;
			case "Password":
